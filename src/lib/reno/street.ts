...
export const STREET_NPCS: StreetNpc[] = [
  ...
  },
  {
    ...
    district: "shark",
    shift: "any",
    beat: "a service door, not the Virgin Street lamps",
    day: "Lang keeps the Bishop code off the felt. He does not wear a badge. Badges left with the old city.",
    night: "Lang is in the alley behind the Shark. The strip stays pretty. The code does not.",
    uses: ["casino", "office"],
    job: {
      id: "lang-witness",
      title: "A name for a quiet week",
      to: "bishop",
      pay: 60,
      item: "a folded witness slip",
      blurb: "Lang wants the slip on a Bishop desk. The families keep the peace the police used to pretend at.",
    },
  },
  {
    id: "jules",
